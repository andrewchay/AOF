...
当前交付面由能力清单自动生成：**178 个 HTTP 操作 / 169 个 HTTP 路径 / 40 个 MCP 工具 / 3 个 CLI 入口 / 9 个 UI 路由**。详见 [`config/capabilities/capability-manifest.json`](config/capabilities/capability-manifest.json)。
